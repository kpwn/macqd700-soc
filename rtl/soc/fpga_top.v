...
module fpga_top #(
    ...
    // Reset-safe staged CMD25 writes. Set 0 only for legacy CMD24 A/B tests;
    // staging adds first-sector latency while subsequent sectors overlap.
    parameter integer SD_SAFE_CMD25 = 1,
