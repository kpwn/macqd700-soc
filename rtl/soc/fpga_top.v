...
module fpga_top #(
    ...
    // Experimental staged CMD25 writes, opt-in only. The board hit a
    // data-response failure and fatal peripheral-write wedge with this enabled.
    // Default to the established closed-per-sector CMD24 path (no staging).
