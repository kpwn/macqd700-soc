...
$(SCSI_SD_E2E_PROD_BUILD)/Vtb_scsi_sd_e2e: $(SCSI_SD_E2E_RTL) \
		$(RTL_DIR)/soc/vhdd_mux.v $(TB_DIR)/tb_scsi_sd_e2e.cpp
	$(call SCSI_SD_E2E_BUILD_RULE,$(SCSI_SD_E2E_PROD_BUILD),+define+SCSI_E2E_C96 +define+SCSI_E2E_READAHEAD +define+SCSI_E2E_PRODUCTION +define+SCSI_REAL_TIMEOUTS -CFLAGS "-DSCSI_E2E_C96 -DSCSI_E2E_PERF_OPT")
...
$(SCSI_SD_E2E_PROD_BASE_BUILD)/Vtb_scsi_sd_e2e: $(SCSI_SD_E2E_RTL) \
		$(RTL_DIR)/soc/vhdd_mux.v $(TB_DIR)/tb_scsi_sd_e2e.cpp
	$(call SCSI_SD_E2E_BUILD_RULE,$(SCSI_SD_E2E_PROD_BASE_BUILD),+define+SCSI_E2E_C96 +define+SCSI_E2E_READAHEAD +define+SCSI_E2E_PRODUCTION +define+SCSI_REAL_TIMEOUTS +define+SCSI_E2E_LEGACY_PACE -CFLAGS "-DSCSI_E2E_C96")
...
$(SCSI_SD_E2E_PROD100_BUILD)/Vtb_scsi_sd_e2e: $(SCSI_SD_E2E_RTL) \
		$(RTL_DIR)/soc/vhdd_mux.v $(TB_DIR)/tb_scsi_sd_e2e.cpp
	$(call SCSI_SD_E2E_BUILD_RULE,$(SCSI_SD_E2E_PROD100_BUILD),+define+SCSI_E2E_C96 +define+SCSI_E2E_READAHEAD +define+SCSI_E2E_PRODUCTION +define+SCSI_REAL_TIMEOUTS +define+SCSI_E2E_CORE100 -CFLAGS "-DSCSI_E2E_C96 -DSCSI_E2E_CORE100 -DSCSI_E2E_PERF_OPT")
